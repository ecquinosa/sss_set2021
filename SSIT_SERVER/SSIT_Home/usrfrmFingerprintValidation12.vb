...
Public Class usrfrmFingerprintValidation12
    ...
    Private Sub BindFingerScanningImage()
        ...
        'MessageBox.Show(String.Format("Me Width {0} Height {1}, BackgroundImage Width {2} Height {3}, X {4} Y {5}", Me.Width, Me.Height, Me.BackgroundImage.Width, Me.BackgroundImage.Height, intX, intY))
